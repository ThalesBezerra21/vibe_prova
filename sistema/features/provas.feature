...
Funcionalidade: Gerenciamento de Provas
  ...
  Cenário: Criar uma nova prova selecionando questões do banco
    ...
    E eu tento selecionar 2 questões disponíveis na listagem
    E eu aperto no botão "Salvar Prova"
  ...
  Cenário: Visualizar e Exportar a prova em PDF
    ...
    Quando eu tento clicar no botão de download de PDF ou visualizar a prova "Prova de Matemática B1"
  ...
  Cenário: Editar uma prova
    ...
    Quando eu tento clicar no botão de "Editar" da prova "Prova P1"
